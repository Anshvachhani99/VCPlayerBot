...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Request_Movies_V3'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/Request_Movies_V3')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/Request_Movies_V3'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Request_Movies_V3'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy", url='https://t.me/Request_Movies_V3'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
